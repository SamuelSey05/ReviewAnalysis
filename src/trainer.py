...
def train_aspect_sentiment_extractor(
    ...
    if plot_progress:
        plot_losses(losses, output_path="aspect_sentiment_training_loss_5_epochs.png")
        plot_accuracies(aspect_accuracies, sentiment_accuracies, output_path="aspect_sentiment_training_accuracies_5_epochs.png")
